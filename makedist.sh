...
cp "CMakeLists.txt" "LICENSE.txt" "README.md" "NEWS.md" "config.h.cmake" "makedist.sh" "makepot.sh" "supertux-origins.appdata.xml" "supertux-origins.desktop" "version.cmake" "version.cmake.in" "version.h.in" $DISTDIR
