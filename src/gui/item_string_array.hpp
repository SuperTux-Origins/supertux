...
{
public:
  ItemStringArray(std::string const& text, std::vector<std::string>& items, int id = -1);
...
private:
  ItemStringArray(ItemStringArray const&) = delete;
  ItemStringArray& operator=(ItemStringArray const&) = delete;
};
