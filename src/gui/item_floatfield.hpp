...
{
public:
  ItemFloatField(std::string const& text_, float* input_, int id_ = -1, bool positive = false);
...
private:
  ItemFloatField(ItemFloatField const&) = delete;
  ItemFloatField& operator=(ItemFloatField const&) = delete;
};
